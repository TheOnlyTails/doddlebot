...
val rules: CommandAction = {
    replyEmbeds(Embed {
        ...
        field("Don't post", """NSFW (Not Safe For Work), NSFL (Not Safe For Life) and lewd content.
                |Advertising other discord server is strictly NOT alowed (Please DM a manager josh about server Advertising)
                |""".trimMargin()
        )
        field("Serious channel", """[This is an opt-in channel use d!serious for more info]
